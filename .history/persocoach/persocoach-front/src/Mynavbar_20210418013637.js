  ...
  render() {
    ...
    return (
      ...
      <Navbar.Collapse >
        ...
        <Navbar.Brand href="#home" style={{marginRight: "150px" , marginLeft: "150px" }} 
        className="d-flex justify-content-center" ><img src="11.png" height="165px" width="302px"></img></Navbar.Brand>
